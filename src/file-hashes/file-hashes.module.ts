  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: (
        ...
        return new GetFileHashUseCase(fileHashRepository, fileHashPresenter);
      },
      inject: [FILE_HASH_REPOSITORY, FILE_HASH_PRESENTER],
    },
  ],
  exports: [FILE_HASH_REPOSITORY, FILE_HASH_PRESENTER, GetFileHashUseCase],
})
